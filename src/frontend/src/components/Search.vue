...
<script>
  ...
  * vuex들중 state만 map연결한 덩어리들,
  * 왜 {}? 총 4개라서 4개중에 하나만 가져와라..
  * {} 빠지면 일반 mapState가 되어버림..!*/
  ...
  export default {
    ...
    computed: {
      ...mapState({ /*여러개일 때 : ...씀, 여러개중 하나*/
      bugsmusic: (state)=> state.crawling.bugsmusic /*모듈화*/
      /*bugsmusic2: crawling.state.bugsmusic 정석*/
      })
    }, /*표현식*/
    methods: {
      search() {
